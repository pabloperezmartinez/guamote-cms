				...
				<div class="ui stackable grid">
					<div class="middle aligned row">
						<div class="ui three wide column">
							<img src="<?php bloginfo('stylesheet_directory'); ?>/img/logo_analaogo_w_360.png" class="ui small image"/>
						</div>
						...
						<div class="ui six wide right aligned column">
							<p>
								<a href="https://www.facebook.com/Centro-de-Capacitación-José-Pedro-Varela-1190210507662720/?fref=ts" target="_blank"><i class="circular inverted blue facebook icon"></i></a>
								...
								<a href="<?php echo site_url();?>/rss" target="_blank"><i class="circular inverted orange rss icon"></i></a>
							</p>
